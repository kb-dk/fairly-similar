...
//static String jsonDataFile = "/home/abr/projects/fairly-similar/data/kb_all_lines.json";
   ...
   */
    ...
    public static SortedSet<ImageNumberWithDistance> findAndListBestHeuristicMarkers(double[] orgCoords,
                                                                                     int numberOfBest)
            throws Exception {
    ...
    public static SortedSet<ImageNumberWithDistance> findAndListBestHeuristicPredictions(ArrayList<Prediction> predictions,
                                                                                         int hits) throws Exception {
        //System.out.println("id:"+testId +" : coords:"+Arrays.toString(orgCoords));
    ...
    public static SortedSet<ImageNumberWithDistance> findAndListBestHeuristicMixed(double[] coordinates,
        ...
        query.append("(");
        for (Prediction p : predictions) {
            query.append("designation:\"" + p.getDesignation() + "\"^" + p.getProbability() * 30
                         + " OR "); //boost 30 so it compare to bitmap score
    ...
    public static ArrayList<String> getIdsForBestHeuristic(int testId, double[] orgCoords, int solrResults)
            throws Exception {
...
*/
    ...
    */
     ...
     */
    public static SortedSet<ImageNumberWithDistance> findBestBruteForce(double[] coords, int numberOfHits, String file)
            throws Exception {
